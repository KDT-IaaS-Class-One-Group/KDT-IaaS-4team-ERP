    ...
    return (
        <div className="flex flex-col items-center bg-black text-white">
            ...
            <div className="bg-gray-400 w-4/5 h-50 mb-4">
                <input type="text" className="w-full h-full text-white bg-black text-left py-4 pl-2" placeholder="제목" />
            </div>

            {/* Area2: 글 쓰기 내용 */}
            <div className="bg-gray-400 w-4/5 h-96 mb-4">
                <textarea className="w-full h-full text-white bg-black text-left py-4 pl-2" placeholder="내용" />
            </div>
